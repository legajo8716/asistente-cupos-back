...
import com.edu.asistenteCupos.service.adapter.EstudianteCsvAdapter;
...
class AsistenteController {
  ...
  private final EstudianteCsvAdapter estudianteCsvAdapter;
  ...
  public ResponseEntity<List<SugerenciaInscripcionDto>> sugerirInscripcionConCsv(@RequestParam(required = false) MultipartFile file) {
    try {
      List<PeticionInscripcion> peticiones = estudianteCsvAdapter.convertirP(file);
