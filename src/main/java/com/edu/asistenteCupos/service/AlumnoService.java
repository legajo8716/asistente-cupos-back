...
public class AlumnoService {
  ...
  public String consultar(String userInput) throws JsonProcessingException {
    String prompsIngeniering =
      "Asign� cupos de materias a peticiones seg�n prioridad. Datos disponibles: cupos por materia, inscripciones �ltimos 3 cuatrimestres, inscripciones actuales, aprobadas �ltimo a�o, materia solicitada, totales de inscripciones y aprobadas, materias para graduarse, correlativas. " +
